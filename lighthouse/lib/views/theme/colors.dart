...
ColorTheme colorThemeLight = ColorTheme(
  ...
  primaryColorDark: const Color.fromRGBO(211, 243, 107, 1),
  ...
  textSecondaryColor: const Color.fromRGBO(142, 142, 147, 1),
  ...
  inputFocusBorderColor: const Color.fromARGB(255, 0, 0, 0),
