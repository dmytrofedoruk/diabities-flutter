...
TextTheme _buildTextTheme(TextTheme base, String fontFamily, Color color, Color secondColor, Color thirdColor) {
  return base.copyWith(
    headline1: base.headline1!.copyWith(fontFamily: fontFamily, fontSize: 96, fontWeight: FontWeight.w500, color: color),
    headline2: base.headline2!.copyWith(fontFamily: fontFamily, fontSize: 60, fontWeight: FontWeight.w500, color: color),
    headline3: base.headline3!.copyWith(fontFamily: fontFamily, fontSize: 48, fontWeight: FontWeight.w500, color: color),
    headline4: base.headline4!.copyWith(fontFamily: fontFamily, fontSize: 34, fontWeight: FontWeight.w500, color: color),
