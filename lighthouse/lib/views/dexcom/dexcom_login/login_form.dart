...
class DexcomLoginForm extends StatefulWidget {
  const DexcomLoginForm({Key? key}) : super(key: key);

  @override
  State<DexcomLoginForm> createState() => _DexcomLoginFormState();
}

class _DexcomLoginFormState extends State<DexcomLoginForm> with LoadingMixin {
  String userName = '';
  String password = '';
  String pinCode = '';
