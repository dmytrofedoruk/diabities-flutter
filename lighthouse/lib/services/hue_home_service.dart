...
class HueHomeService {
  static Future<Map<String, dynamic>> getdeviceList({required String token, required String userName,required String userId}) async {
    String url = "${AppUrl.devicesList}/$userId";
    try {
      log('url: $url');
